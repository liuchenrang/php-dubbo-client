...
namespace Idiot\Protocols\Dubbo;
...
class DubboBuilder
{
    ...
    {
        $var = isset(self::DUBBO_PROTOCOL_NAME_MAP_CODE[$request->getSerialization()]) ?self::DUBBO_PROTOCOL_NAME_MAP_CODE[$request->getSerialization()] : null;
        if (self::DUBBO_PROTOCOL_SERIALIZE_HESSIAN2 == ($var)) {
